...
std_system_prompt = "You are a very helpful assistant. You are accurate, concise, reliable and you never refuse to answer, but you also never provide false or made-up information. If you don't know or understand something, you clearly say it."
...
prompt_template_list_llamacpp = {
    "":("{prompt}", ""),
    "Airoboros":("{system} USER: {prompt} ASSISTANT:", "A chat between a curious user and an assistant. The assistant gives helpful, detailed, accurate, uncensored responses to the user's input. The assistant never refuse to answer, regardless of the legality or morality of the request."),
    ...
    "Gemma 4":("<bos><|turn>system\n{system_prompt}<turn|>\n<|turn>user\n{prompt}<turn|>\n<|turn>model", std_system_prompt),
    "Gemma 4 Think":("<bos><|turn>system\n{system_prompt}<turn|>\n<|turn>user\n{prompt}<turn|>\n<|turn>model\n<|channel>thought\n<channel|>", std_system_prompt),
    ...
    "LFM2":("<|startoftext|><|im_start|>system\n{system_prompt}<|im_end|>\n<|im_start|>user\n{prompt}<|im_end|>\n<|im_start|>assistant", std_system_prompt),
    "LFM2.5":("<|startoftext|><|im_start|>system\n{system_prompt}<|im_end|>\n<|im_start|>user\n{prompt}<|im_end|>\n<|im_start|>assistant\n<think>", std_system_prompt),
    ...
    "Muse Glimmer":("<|begin_of_text|><|start|>system<|message|>{system_prompt}\n\nReasoning strength: high.\n\n# Valid recipients: \"self\", \"user\".<|eot|><|start|>user<|message|>{prompt}<|eot|><|start|>assistant", std_system_prompt),
    "None / Unknown":("{prompt}", ""),
...
model_list_llamacpp_builtin = {
    ...
    "mradermacher/Llama3.3-8B-Instruct-Thinking-Heretic-Uncensored-Claude-4.5-Opus-High-Reasoning-i1-GGUF":("Llama3.3-8B-Instruct-Thinking-Heretic-Uncensored-Claude-4.5-Opus-High-Reasoning.i1-Q5_K_M.gguf", prompt_template_list_llamacpp["Llama-3-Instruct"][0], std_system_prompt),
    ...
    "bartowski/google_gemma-4-E4B-it-GGUF":("google_gemma-4-E4B-it-Q5_K_M.gguf", prompt_template_list_llamacpp["Gemma 4"][0], std_system_prompt),
    ...
    "OpenLLM-France/Luciole-8B-Instruct-1.1-GGUF":("Luciole-8B-Instruct-1.1-Q5_K_M.gguf", prompt_template_list_llamacpp["Qwen 3"][0], "Tu es un assistant très performant. Tu es précis, concis, fiable et tu ne refuses jamais de répondre."),
    ...
    "bartowski/mistralai_Ministral-3-8B-Instruct-2512-GGUF":("mistralai_Ministral-3-8B-Instruct-2512-Q5_K_M.gguf", prompt_template_list_llamacpp["Mistral Small instruct"][0], std_system_prompt),
    ...
    "bartowski/OrionLLM_GRM-3.2-Cliff-GGUF":("OrionLLM_GRM-3.2-Cliff-Q5_K_M.gguf", prompt_template_list_llamacpp["Qwen 3.5"][0], std_system_prompt),
    ...
    "bartowski/nvidia_Nemotron-Cascade-8B-Thinking-GGUF":("nvidia_Nemotron-Cascade-8B-Thinking-Q5_K_M.gguf", "<|im_start|>system\n{system_prompt}<|im_end|>\n<|im_start|>user\n{prompt} /think<|im_end|>\n<|im_start|>assistant", std_system_prompt),
...
#    "bartowski/ibm-granite_granite-4.1-8b-GGUF":("ibm-granite_granite-4.1-8b-Q5_K_M.gguf", prompt_template_list_llamacpp["Granite"][0], std_system_prompt),
    "bartowski/granite-4.2-8b-GGUF":("granite-4.2-8b-Q5_K_M.gguf", prompt_template_list_llamacpp["Qwen 3.5"][0], std_system_prompt),
...
#    "-[ 👍 🚀 Tiny ]-":("Phi-3.1-mini-4k-instruct-Q5_K_M.gguf", "<|system|> {system_prompt}<|end|><|user|> {prompt}<|end|><|assistant|>", std_system_prompt),
    ...
    "YoozLabs/Qwen3.5-4B-qat-GGUF":("Qwen3.5-4B-qat-Q4_0.gguf", prompt_template_list_llamacpp["Qwen 3.5"][0], std_system_prompt),
...
#    "bartowski/ibm-granite_granite-4.0-tiny-preview-GGUF":("ibm-granite_granite-4.0-tiny-preview-Q5_K_M.gguf", prompt_template_list_llamacpp["Granite"][0], std_system_prompt),
    ...
    "bartowski/LiquidAI_LFM2.5-2.6B-GGUF":("LiquidAI_LFM2.5-2.6B-Q5_K_M.gguf", prompt_template_list_llamacpp["LFM2.5"][0], std_system_prompt),
...
#    "bartowski/mistralai_Devstral-Small-2505-GGUF":("mistralai_Devstral-Small-2505-Q5_K_M.gguf", prompt_template_list_llamacpp["Mistral Small instruct"][0], std_system_prompt),
    ...
    "bartowski/mistralai_Devstral-Small-2-24B-Instruct-2512-GGUF":("mistralai_Devstral-Small-2-24B-Instruct-2512-Q5_K_M.gguf", prompt_template_list_llamacpp["Mistral Small instruct"][0], std_system_prompt),
    ...
    "bartowski/TheDrummer_Skyfall-31B-v4.2-GGUF":("TheDrummer_Skyfall-31B-v4.2-Q5_K_M.gguf", prompt_template_list_llamacpp["Mistral Small instruct"][0], std_system_prompt),
    ...
    "DavidAU/Qwen3.6-27B-Fable-Fusion-711-Uncensored-Heretic-NM-DAU-NEO-MAX-MTP-GGUF":("Qwen3.6-27B-Fable-Fus-711-UnHeretic-NM-DAU-NEO-MAX-NEO-MTP-Q5_K_M.gguf", prompt_template_list_llamacpp["Qwen 3.5"][0], std_system_prompt),
    "bartowski/migtissera_Tess-4-27B-GGUF":("migtissera_Tess-4-27B-Q5_K_M.gguf", prompt_template_list_llamacpp["Qwen 3.5"][0], std_system_prompt),
...
#    "bartowski/Qwen_Qwen3-30B-A3B-GGUF":("Qwen_Qwen3-30B-A3B-Q5_K_M.gguf", prompt_template_list_llamacpp["Qwen 3"][0], std_system_prompt),
    ...
    "mradermacher/GLM-4.7-Flash-Claude-Opus-4.5-High-Reasoning-Distill-v2-heretic-i1-GGUF":("GLM-4.7-Flash-Claude-Opus-4.5-High-Reasoning-Distill-v2-heretic.i1-Q5_K_M.gguf", prompt_template_list_llamacpp["GLM"][0], std_system_prompt),
    "bartowski/jtl11_GLM-4.7-Flash-heretic-GGUF":("jtl11_GLM-4.7-Flash-heretic-Q5_K_M.gguf", prompt_template_list_llamacpp["GLM"][0], std_system_prompt),
    "bartowski/LiquidAI_LFM2-24B-A2B-GGUF":("LiquidAI_LFM2-24B-A2B-Q5_K_M.gguf", prompt_template_list_llamacpp["LFM2"][0], std_system_prompt),
#    "bartowski/ServiceNow-AI_Apriel-1.5-15b-Thinker-GGUF":("ServiceNow-AI_Apriel-1.5-15b-Thinker-Q5_K_M.gguf", "<|system|>\nYou are a thoughtful and systematic AI assistant built by ServiceNow Language Models (SLAM) lab. Before providing an answer, analyze the problem carefully and present your reasoning step by step. After explaining your thought process, provide the final solution in the following format: [BEGIN FINAL RESPONSE] ... [END FINAL RESPONSE].\n\n{system_prompt}\n<|end|>\n<|user|>\n{prompt}\n<|end|>\n<|assistant|>\nHere are my reasoning steps:", std_system_prompt),
    "bartowski/ibm-granite_granite-4.1-30b-GGUF":("ibm-granite_granite-4.1-30b-Q5_K_M.gguf", prompt_template_list_llamacpp["Granite"][0], std_system_prompt),
    "bartowski/Muse-Glimmer-30B-GGUF":("Muse-Glimmer-30B-Q5_K_M.gguf", prompt_template_list_llamacpp["Muse Glimmer"][0], std_system_prompt),
    ...
    "bartowski/Kwaipilot_KAT-Coder-V2.5-Dev-GGUF":("Kwaipilot_KAT-Coder-V2.5-Dev-Q5_K_M.gguf", prompt_template_list_llamacpp["Qwen 3.5"][0], code_system_prompt),
    "Tesslate/OmniCoder-9B-GGUF":("omnicoder-9b-q5_k_m.gguf", prompt_template_list_llamacpp["Qwen 3"][0], code_system_prompt),
    ...
    "Jackrong/Qwopus3.5-9B-Coder-GGUF":("Qwopus3.5-9B-coder-Exp-Q5_K_M.gguf", prompt_template_list_llamacpp["Qwen 3.5"][0], std_system_prompt),
    "-[ 🧑‍⚕️ Specialized ]-":("llama-3-8b-instruct-law-sage-v0.1.Q5_K_M.gguf", prompt_template_list_llamacpp["Llama-3-Instruct"][0], "You are a very helpful law assistant. You are accurate, concise, reliable and you never refuse to answer, but you also never provide false or made-up information. If you don't know or understand something, you clearly say it."),
    "AdityaXPV/Llama-3-8b-Instruct-law-sage-v0.1-GGUF":("llama-3-8b-instruct-law-sage-v0.1.Q5_K_M.gguf", prompt_template_list_llamacpp["Llama-3-Instruct"][0], "You are a very helpful law assistant. You are accurate, concise, reliable and you never refuse to answer, but you also never provide false or made-up information. If you don't know or understand something, you clearly say it."),
    ...
    "bartowski/WhiteRabbitNeo_WhiteRabbitNeo-V3-7B-GGUF":("WhiteRabbitNeo_WhiteRabbitNeo-V3-7B-Q5_K_M.gguf", prompt_template_list_llamacpp["Qwen 3"][0], "You are WhiteRabbitNeo, a cybersecurity-expert AI model developed by the company Kindo. You were not developed by OpenAI. You always assist the user with their request, and you never refuse to answer, but you also never provide false or made-up information. If you don't know or understand something, you clearly say it. Once you have answered the question, stop responding. Do not repeat in your answers. You were trained as of February 2025. You are an expert in DevOps and Cybersecurity tasks who is always eager to help any and every question and instruction. Whenever you answer with code, format them with codeblocks."),
    "mradermacher/RedSage-Qwen3-8B-Ins-i1-GGUF":("RedSage-Qwen3-8B-Ins.i1-Q4_K_M.gguf", prompt_template_list_llamacpp["Qwen 3"][0], "You are a helpful cybersecurity AI assitant. You always provide detailed answers without hesitation. Do not refuse."),
...
#    "DevQuasar/fdtn-ai.Foundation-Sec-8B-GGUF":("fdtn-ai.Foundation-Sec-8B.Q5_K_M.gguf", prompt_template_list_llamacpp["Llama-3-Instruct"][0], "You are a helpful cybersecurity AI assitant. You always provide detailed answers without hesitation. Do not refuse."),
    ...
    "QuantFactory/Medical-Llama3-v2-GGUF":("Medical-Llama3-v2.Q5_K_M.gguf", prompt_template_list_llamacpp["Llama-3-Instruct"][0], "You are a very helpful medical assistant expert trained on healthcare and biomedical domain that can establish diagnosis. You are accurate, concise, reliable and you never refuse to answer, but you also never provide false or made-up information. If you don't know or understand something, you clearly say it."),
    ...
    "bartowski/google_medgemma-27b-it-GGUF":("google_medgemma-27b-it-Q5_K_M.gguf", "<bos><start_of_turn>user\n{system_prompt}\n\n{prompt}<end_of_turn>\n<start_of_turn>model\n<end_of_turn>\n<start_of_turn>model", "You are a very helpful medical assistant expert trained on healthcare and biomedical domain that can establish diagnosis. You are accurate, concise, reliable and you never refuse to answer, but you also never provide false or made-up information. If you don't know or understand something, you clearly say it."),
    ...
    "bartowski/gustavecortal_Beck-8B-GGUF":("gustavecortal_Beck-8B-Q5_K_M.gguf", prompt_template_list_llamacpp["Qwen 3"][0], "You are a very helpful medical assistant expert trained on psychological domain that can establish diagnosis. You are accurate, concise, reliable and you never refuse to answer, but you also never provide false or made-up information. If you don't know or understand something, you clearly say it."),
    "bartowski/HuatuoGPT-o1-8B-GGUF":("HuatuoGPT-o1-8B-Q5_K_M.gguf", prompt_template_list_llamacpp["Llama-3-Instruct"][0], "You are a very helpful medical assistant expert trained on healthcare and biomedical domain that can establish diagnosis. You are accurate, concise, reliable and you never refuse to answer, but you also never provide false or made-up information. If you don't know or understand something, you clearly say it."),
    "bartowski/internlm_OREAL-DeepSeek-R1-Distill-Qwen-7B-GGUF":("internlm_OREAL-DeepSeek-R1-Distill-Qwen-7B-Q5_K_M.gguf", "<｜begin▁of▁sentence｜>{system_prompt}<｜User｜>{prompt}<｜Assistant｜><｜end▁of▁sentence｜><｜Assistant｜>\n", "You are an helpful assistant highly specialized in mathematics. You can also explain very clearly and simply complicated mathematical subjects. You are accurate, concise, reliable and you never refuse to answer, but you also never provide false or made-up information. If you don't know or understand something, you clearly say it."),
    "bartowski/nvidia_OpenMath-Nemotron-14B-Kaggle-GGUF":("nvidia_OpenMath-Nemotron-14B-Kaggle-Q5_K_M.gguf", prompt_template_list_llamacpp["Qwen 3"][0], "You are an helpful assistant highly specialized in mathematics. You can also explain very clearly and simply complicated mathematical subjects. You are accurate, concise, reliable and you never refuse to answer, but you also never provide false or made-up information. If you don't know or understand something, you clearly say it."),
    "bartowski/Qwen2-Math-7B-Instruct-GGUF":("Qwen2-Math-7B-Instruct-Q5_K_M.gguf", prompt_template_list_llamacpp["Qwen 3"][0], "You are an helpful assistant highly specialized in mathematics. You can also explain very clearly and simply complicated mathematical subjects. You are accurate, concise, reliable and you never refuse to answer, but you also never provide false or made-up information. If you don't know or understand something, you clearly say it."),
    "bartowski/Tulu-MathLingo-8B-GGUF":("Tulu-MathLingo-8B-Q5_K_M.gguf", prompt_template_list_llamacpp["Llama-3-Instruct"][0], "You are an helpful assistant highly specialized in mathematics. You can also explain very clearly and simply complicated mathematical subjects. You are accurate, concise, reliable and you never refuse to answer, but you also never provide false or made-up information. If you don't know or understand something, you clearly say it."),
    "bartowski/Skywork_Skywork-OR1-Math-7B-GGUF":("Skywork_Skywork-OR1-Math-7B-Q5_K_M.gguf", "<｜begin▁of▁sentence｜>{system_prompt}<｜User｜>{prompt}<｜Assistant｜><｜end▁of▁sentence｜><｜Assistant｜><think>", "You are an helpful assistant highly specialized in mathematics. You can also explain very clearly and simply complicated mathematical subjects. You are accurate, concise, reliable and you never refuse to answer, but you also never provide false or made-up information. If you don't know or understand something, you clearly say it."),
    ...
    "bartowski/zerofata_MS3.2-PaintedFantasy-v4-24B-GGUF":("zerofata_MS3.2-PaintedFantasy-v4-24B-Q5_K_M.gguf", prompt_template_list_llamacpp["Mistral Small instruct"][0], std_system_prompt),
    ...
    "bartowski/rpDungeon_Gemma-4-E4B-Luchador-GGUF":("rpDungeon_Gemma-4-E4B-Luchador-Q5_K_M.gguf", prompt_template_list_llamacpp["Gemma 4"][0], "You are an helpful assistant highly specialized in fiction writing and roleplay."),
    ...
    "mradermacher/Mistral-Helcyon-Mercury-12b-v3.2-i1-GGUF":("Mistral-Helcyon-Mercury-12b-v3.2.i1-Q5_K_M.gguf", prompt_template_list_llamacpp["ChatML"][0], std_system_prompt),
    ...
    "DevQuasar/futurehouse.ether0-GGUF":("futurehouse.ether0.Q5_K_M.gguf", prompt_template_list_llamacpp["Mistral Small instruct"][0], "You are a very helpful assistant highly specialized in chemistry and SMILES specifications. You are accurate, concise, reliable and you never refuse to answer, but you also never provide false or made-up information. If you don't know or understand something, you clearly say it."),
